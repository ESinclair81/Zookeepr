...
//* Function to find a single animal from the animals array **/
  ...
  //* Function that takes req.body and writes data to animals.json *//
  ...
  //* Function to validate json data from req.body *//
  ...
  //* User populate animals method(post route callback)  */
